...
After forking the [PD upstream](https://github.com/gottingen/tm/fork) source repository to your personal repository. You can set up your personal development environment for PD project.
...
```sh
$ git remote add upstream https://github.com/gottingen/tm
$ git fetch upstream

...
func TestRegistryService(t *testing.T) {
	re := require.New(t)
	re.NoError(failpoint.Enable("github.com/gottingen/tm/server/useGlobalRegistry", "return(true)"))
	...
	re.NoError(failpoint.Disable("github.com/gottingen/tm/server/useGlobalRegistry"))
}

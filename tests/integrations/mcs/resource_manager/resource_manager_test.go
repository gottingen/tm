...
import (
	...
	// Register Service
	_ "github.com/gottingen/tm/pkg/mcs/registry"
	_ "github.com/gottingen/tm/pkg/mcs/resource_manager/server/install"
)
...
func (suite *resourceManagerClientTestSuite) SetupSuite() {
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/mcs/resource_manager/server/enableDegradedMode", `return(true)`))
...
func (suite *resourceManagerClientTestSuite) TearDownSuite() {
	...
	suite.clean()
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/mcs/resource_manager/server/enableDegradedMode"))
}
...
// TestSwitchBurst is used to test https://github.com/gottingen/tm/issues/6209
func (suite *resourceManagerClientTestSuite) TestSwitchBurst() {
	re := suite.Require()
	cli := suite.client
	re.NoError(failpoint.Enable("github.com/gottingen/tm/client/resource_group/controller/acceleratedReportingPeriod", "return(true)"))
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/client/resource_group/controller/acceleratedSpeedTrend", "return(true)"))
	...
	re.NoError(failpoint.Disable("github.com/gottingen/tm/client/resource_group/controller/acceleratedReportingPeriod"))
	re.NoError(failpoint.Disable("github.com/gottingen/tm/client/resource_group/controller/acceleratedSpeedTrend"))
	controller.Stop()
}
...
func (suite *resourceManagerClientTestSuite) TestAcquireTokenBucket() {
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/mcs/resource_manager/server/fastPersist", `return(true)`))
	...
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/mcs/resource_manager/server/fastPersist"))
}
...
func (suite *resourceManagerClientTestSuite) TestResourceManagerClientDegradedMode() {
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/mcs/resource_manager/server/acquireFailed", `return(true)`))
	re.NoError(failpoint.Enable("github.com/gottingen/tm/client/resource_group/controller/degradedModeRU", "return(true)"))
	...
	controller.Stop()
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/mcs/resource_manager/server/acquireFailed"))
	re.NoError(failpoint.Disable("github.com/gottingen/tm/client/resource_group/controller/degradedModeRU"))
}
...
func (suite *resourceManagerClientTestSuite) TestLoadRequestUnitConfig() {
	...
	re.Equal(expectedConfig.WriteBytesCost, config.WriteBytesCost)
	re.Equal(expectedConfig.CPUMsCost, config.CPUMsCost)
	// refer github.com/gottingen/tm/pkg/mcs/resource_manager/server/enableDegradedMode, check with 1s.
...
func (suite *resourceManagerClientTestSuite) TestRemoveStaleResourceGroup() {
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/client/resource_group/controller/fastCleanup", `return(true)`))
	...
	re.NoError(failpoint.Disable("github.com/gottingen/tm/client/resource_group/controller/fastCleanup"))
	controller.Stop()
}

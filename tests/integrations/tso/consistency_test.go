...
func (suite *tsoConsistencyTestSuite) TestFallbackTSOConsistency() {
	...
	suite.TearDownSuite()
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/tso/fallBackSync", `return(true)`))
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/tso/fallBackUpdate", `return(true)`))
	suite.SetupSuite()
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/tso/fallBackSync"))
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/tso/fallBackUpdate"))

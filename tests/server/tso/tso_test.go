...
func TestLoadTimestamp(t *testing.T) {
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/tso/systemTimeSlow", `return(true)`))
	...
	failpoint.Disable("github.com/gottingen/tm/pkg/tso/systemTimeSlow")
}

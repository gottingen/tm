...
func TestRegionSyncer(t *testing.T) {
	...
	re.NoError(failpoint.Disable("github.com/gottingen/tm/server/syncer/noFastExitSync"))
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/storage/regionStorageFastFlush"))
}
...
func TestPrepareChecker(t *testing.T) {
	...
	re.NoError(failpoint.Disable("github.com/gottingen/tm/server/cluster/changeCoordinatorTicker"))
}

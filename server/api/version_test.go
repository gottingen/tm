...
func TestGetVersion(t *testing.T) {
	// TODO: enable it.
	t.Skip("Temporary disable. See issue: https://github.com/gottingen/tm/issues/1893")
	re := require.New(t)
	...
	go func(cfg *config.Config) {
		...
		re.NoError(err)
		re.NoError(failpoint.Enable("github.com/gottingen/tm/server/memberNil", `return(true)`))
		reqCh <- struct{}{}
		err = s.Run()
		re.NoError(err)
		ch <- s
	...
	re.NoError(failpoint.Disable("github.com/gottingen/tm/server/memberNil"))
}

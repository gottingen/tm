...
// For issue https://github.com/gottingen/tm/issues/3936
func TestLoadRegion(t *testing.T) {
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/storage/base_backend/slowLoadRegion", "return(true)"))
	defer func() {
		re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/storage/base_backend/slowLoadRegion"))
	}()

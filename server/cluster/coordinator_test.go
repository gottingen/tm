...
import (
	...
	"github.com/gottingen/tm/pkg/mock/mockhbstream"
...
func TestCheckCache(t *testing.T) {
	...
	re.NoError(tc.addLeaderRegion(1, 2, 3))
	re.NoError(failpoint.Enable("github.com/gottingen/tm/server/cluster/break-patrol", `return`))
	...
	co.wg.Wait()
	re.NoError(failpoint.Disable("github.com/gottingen/tm/server/cluster/break-patrol"))
}

...
func TestLoadMinServiceSafePoint(t *testing.T) {
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/storage/endpoint/removeExpiredKeys", "return(true)"))
	...
	re.NoError(err)
	re.Nil(ssp)
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/storage/endpoint/removeExpiredKeys"))
}

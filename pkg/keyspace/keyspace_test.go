...
func (suite *keyspaceTestSuite) SetupSuite() {
	suite.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/keyspace/skipSplitRegion", "return(true)"))
}

func (suite *keyspaceTestSuite) TearDownSuite() {
	suite.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/keyspace/skipSplitRegion"))
}

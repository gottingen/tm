...
func TestEtcdClientSync(t *testing.T) {
	re := require.New(t)
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/utils/etcdutil/autoSyncInterval", "return(true)"))
	...
	require.NoError(t, failpoint.Disable("github.com/gottingen/tm/pkg/utils/etcdutil/autoSyncInterval"))
}
...
func TestEtcdWithHangLeaderEnableCheck(t *testing.T) {
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/utils/etcdutil/closeKeepAliveCheck", "return(true)"))
	err = checkEtcdWithHangLeader(t)
	re.Error(err)
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/utils/etcdutil/closeKeepAliveCheck"))
}

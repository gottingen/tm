...
import (
	...
	mcsutils "github.com/gottingen/tm/pkg/mcs/utils"
	"github.com/gottingen/tm/pkg/storage/endpoint"
	"github.com/gottingen/tm/pkg/utils/memberutil"
...
func (suite *keyspaceGroupManagerTestSuite) TestLoadKeyspaceGroupsTimeout() {
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/tso/delayLoadKeyspaceGroups", "return(3)"))
	err := mgr.Initialize()
	...
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/tso/delayLoadKeyspaceGroups"))
}
...
func (suite *keyspaceGroupManagerTestSuite) TestLoadKeyspaceGroupsSucceedWithTempFailures() {
	...
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/tso/loadKeyspaceGroupsTemporaryFail", "return(2)"))
	err := mgr.Initialize()
	re.NoError(err)
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/tso/loadKeyspaceGroupsTemporaryFail"))
}
...
func (suite *keyspaceGroupManagerTestSuite) TestLoadKeyspaceGroupsFailed() {
	...
	mgr.loadFromEtcdMaxRetryTimes = 3
	re.NoError(failpoint.Enable("github.com/gottingen/tm/pkg/tso/loadKeyspaceGroupsTemporaryFail", "return(3)"))
	err := mgr.Initialize()
	re.Error(err)
	re.NoError(failpoint.Disable("github.com/gottingen/tm/pkg/tso/loadKeyspaceGroupsTemporaryFail"))
}

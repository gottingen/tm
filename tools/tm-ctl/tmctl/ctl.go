...
import (
	...
	"github.com/gottingen/tm/tools/tm-ctl/tmctl/command"
...
func MainStart(args []string) {
	...
	rootCmd.Flags().BoolP("interact", "i", false, "Run tmctl with readline.")
	rootCmd.Flags().BoolP("version", "V", false, "Print version information and exit.")
	// TODO: deprecated
	rootCmd.Flags().BoolP("detach", "d", true, "Run tmctl without readline.")
